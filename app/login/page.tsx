...
export default function Login() {
  ...
  const handleLogin = async () => {
    ...
    if (!user) { alert("Login failed"); setLoading(false); return; }
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ fontSize: 14, color: "rgba(255,255,255,0.65)", fontWeight: 500, marginTop: 4 }}>
          Login to your Bubbry account
        </div>
      </div>
      ...
      <div style={{
        ...
        <p style={{ textAlign: "center", marginTop: 24, fontSize: 14, color: "#8A96B5", fontWeight: 500 }}>
          ...
          <a href="/signup" style={{ color: "#1A6BFF", fontWeight: 700, textDecoration: "none" }}>
            Sign up
          </a>
        </p>
      </div>
